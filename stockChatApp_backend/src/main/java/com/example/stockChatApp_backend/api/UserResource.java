package com.example.stockChatApp_backend.api;
...
public class UserResource {
    ...
    public ResponseEntity<User> registerUser(@RequestBody User user) {
        ...
        userService.addRoleToUser(user.getUsername(), Role.RoleName.ROLE_USER.toString());
    ...
    public void refreshToken(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if (authorizationHeader != null && authorizationHeader.startsWith("Bearer ")) {
            try {
                ...
                Algorithm algorithm = Algorithm.HMAC256("secret".getBytes()); //todo: remove this in future
                ...
                String access_token = JWT.create()
                        ...
                        .withExpiresAt(new Date(System.currentTimeMillis() + 10 * 60 * 1000)) //change it
